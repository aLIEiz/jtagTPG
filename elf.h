...
typedef struct _elf_info_st
{
    ...
    unsigned int elf_entry_address;
    unsigned int elf_is_x64;
    unsigned int elf_ehsize;

    unsigned int elf_phoff;
    unsigned int elf_phentsize;
    unsigned int elf_phnum;

    unsigned int elf_shoff;
    unsigned int elf_shentsize;
    unsigned int elf_shnum;
}elf_info_st;
